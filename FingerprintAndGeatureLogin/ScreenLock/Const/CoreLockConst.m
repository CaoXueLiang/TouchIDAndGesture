...
/** 选中圆大小的线宽 */
const CGFloat CoreLockArcLineW = 0.5f;
...
/** 设置密码提示文字 */
NSString *const CoreLockPWDTitleFirst = @"为了您的账户安全, 请绘制手势密码";



/** 设置密码提示文字：确认 */
NSString *const CoreLockPWDTitleConfirm = @"请确认手势密码";


/** 设置密码提示文字：再次密码不一致 */
NSString *const CoreLockPWDDiffTitle = @"与首次绘制图案不一致";
 ...
 */
/** 修改密码：普通提示文字 */
NSString *const CoreLockModifyNormalTitle = @"请绘制原手势密码";
