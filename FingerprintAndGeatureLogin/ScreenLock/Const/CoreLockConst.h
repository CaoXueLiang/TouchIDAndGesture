 ...
 *  背景色
 */ 
#define CoreLockViewBgColor rgba(250,250,250,1)

/*
 *  外环线条颜色：默认
 */
#define CoreLockCircleLineNormalColor rgba(177,177,177,1)


/*
 *  外环线条颜色：选中
 */
#define CoreLockCircleLineSelectedColor rgba(250,34,7,1)


/*
 *  实心圆
 */
#define CoreLockCircleLineSelectedCircleColor rgba(250,34,7,1)


/*
 *  实心圆
 */
#define CoreLockLockLineColor rgba(250,34,7,1)
 ...
 *  警示文字颜色
 */
#define CoreLockWarnColor rgba(255,0,0,1)
